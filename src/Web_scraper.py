...
#Lista de atributos de jugadores
...
#Función que elimina los acentos de un cadena de caracteres
...
#Función que compone la url del jugador con '-'
def compose_url(array_name):
	new_url = '-'.join(array_name)
	return remove_accents(new_url)

#Función principal que construye la url final de cada jugador
def build_url(name):
